...
type HeaderProps = {
  ...
  testiRef: React.RefObject<HTMLDivElement | null>;
};
...
const Header = ({ aboutRef }: HeaderProps) => {
  ...
  const menuItems = [
    { name: "Home", href: "/" },
    { name: "About", onClick: handleScrollToAbout },
    { name: "Products", href: "/products" },
    { name: "Testimonials", onClick: handleScrollToTestimonials },
  ];
            ...
            <div className="bg-background in-data-[state=active]:block lg:in-data-[state=active]:flex mb-6 hidden w-full flex-wrap items-center justify-end space-y-8 rounded-3xl border p-6 shadow-2xl shadow-zinc-300/20 md:flex-nowrap lg:m-0 lg:flex lg:w-fit lg:gap-6 lg:space-y-0 lg:border-transparent lg:bg-transparent lg:p-0 lg:shadow-none dark:shadow-none dark:lg:bg-transparent">
              ...
              <div className="flex w-full flex-col space-y-3 sm:flex-row sm:gap-3 sm:space-y-0 md:w-fit lg:border-l lg:pl-6">
                <Button asChild size="sm">
                  <Link href="https://wa.me/6287722887555">
                    <span>Contact</span>
                  </Link>
                </Button>
              </div>
